...
class DashboardSnapshotOrm(Base):
    __tablename__ = "study_room_dashboard_snapshot"
    __table_args__ = (
        Index("ix_dashboard_snapshot_collected_at", "collected_at"),
        Index("ix_dashboard_snapshot_status_collected", "status", "collected_at"),
    )
