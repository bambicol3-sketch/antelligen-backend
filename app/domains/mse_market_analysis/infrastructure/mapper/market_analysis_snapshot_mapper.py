...
class MarketAnalysisSnapshotMapper:

    @staticmethod
    def to_entity(orm: MarketAnalysisSnapshotOrm) -> MarketAnalysisSnapshot:
    ...
    @staticmethod
    def to_orm(entity: MarketAnalysisSnapshot) -> MarketAnalysisSnapshotOrm:
        return MarketAnalysisSnapshotOrm(
