...
class MarketAnalysisSnapshotOrm(Base):
    __tablename__ = "mse_market_analysis_snapshot"
    __table_args__ = (
        Index("ix_mse_market_analysis_collected_at", "collected_at"),
        Index("ix_mse_market_analysis_status_collected", "status", "collected_at"),
    )
