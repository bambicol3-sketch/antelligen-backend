...
MOCK_STOCK_DATA = {
    "005930": {"ticker": "005930", "stock_name": "삼성전자", "market": "KOSPI", "current_price": 72000, "change_rate": -1.23},
    "000660": {"ticker": "000660", "stock_name": "SK하이닉스", "market": "KOSPI", "current_price": 185000, "change_rate": 2.45},
    "005380": {"ticker": "005380", "stock_name": "현대자동차", "market": "KOSPI", "current_price": 248000, "change_rate": 0.81},
    "035420": {"ticker": "035420", "stock_name": "네이버", "market": "KOSPI", "current_price": 210000, "change_rate": -0.47},
    "035720": {"ticker": "035720", "stock_name": "카카오", "market": "KOSPI", "current_price": 42000, "change_rate": 1.20},
}
...
class MockSubAgentProvider(SubAgentProvider):
    def call(self, agent_name: str, ticker: str | None, query: str) -> SubAgentResponse:
        ...
        if handler is None:
            return SubAgentResponse.error(agent_name, f"알 수 없는 에이전트: {agent_name}", execution_time_ms)

        return handler(t, execution_time_ms)
