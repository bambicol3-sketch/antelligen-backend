...
class SectorsSnapshotOrm(Base):
    __tablename__ = "mse_sectors_snapshot"
    __table_args__ = (
        Index("ix_mse_sectors_collected_at", "collected_at"),
        Index("ix_mse_sectors_status_collected", "status", "collected_at"),
    )
